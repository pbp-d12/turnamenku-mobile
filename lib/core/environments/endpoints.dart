class Endpoints {
  ...
  static String registerTeam(int id) => '$baseUrl/tournaments/$id/register_team/';
  static String deregisterTeam(int id) => '$baseUrl/tournaments/$id/deregister_team/';
  static String checkCaptainStatus(int id) => '$baseUrl/tournaments/captain_status/$id/';
}
